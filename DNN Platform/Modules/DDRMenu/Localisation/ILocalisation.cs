...
namespace DotNetNuke.Web.DDRMenu.Localisation
{
    ...
    /// <summary>
    /// The ILocalisation interface can be implemented by menu localization providers in order to localise tabs (pages) or Nodes.
    /// </summary>
    public interface ILocalisation
    {
        /// <summary>
        /// Checks if a module has a DDR localization api implemented.
        /// </summary>
        /// <returns>A value indicating whether the module has the supported localization api.</returns>
        bool HaveApi();

        /// <summary>
        /// Localizes a tab (page) information only (not content).
        /// </summary>
