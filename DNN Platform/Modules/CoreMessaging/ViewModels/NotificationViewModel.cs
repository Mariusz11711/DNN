...
namespace DotNetNuke.Modules.CoreMessaging.ViewModels
{
    ...
    /// <summary>
    /// The view model for a single notification.
    /// </summary>
    public class NotificationViewModel
    {
        ...
        /// <summary>
        /// Gets or sets from who this notification comes from.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the avatar of the sender.
        /// </summary>
        public string SenderAvatar { get; set; }

        /// <summary>
        /// Gets or sets the profile url of the sender.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a list of possible actions on the notification.
        /// </summary>
